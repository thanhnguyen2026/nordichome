      ...
      <aside className="w-56 bg-stone-900 text-stone-300 flex flex-col flex-shrink-0">
        <div className="p-4 border-b border-stone-800">
          <a href="/" className="flex items-center gap-3">
            {settings.logo_url
              ? <img src={settings.logo_url} alt="Logo" className="h-10 w-10 object-contain rounded-lg flex-shrink-0" />
        ...
        <div className="p-4 border-t border-stone-800">
          ...
          <a href="/" className="block mt-2 text-xs text-stone-400 hover:text-amber-200 transition">
            ← Về trang chủ
          </a>
        </div>
      </aside>
