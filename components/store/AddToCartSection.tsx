...
export default function AddToCartSection({ product, onVariantImageChange, onVariantPriceChange, onVariantLabelChange }: Props) {
  ...
  if (!product.in_stock && !product.is_preorder) {
    return (
      <div className="inline-flex items-center px-5 py-3 rounded-xl bg-stone-100 text-stone-500 font-semibold text-sm">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex flex-col min-w-0">
            <span className="text-[10px] text-stone-500 truncate">{product.name}</span>
